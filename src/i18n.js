  ...
  en: {
    ...
    summary: {
      ...
      sendingRequest: "Asking the AI to read it...",
        ...
        usingTosdr: "Found existing ToS;DR rating",
        tosdrSource: "Data from ToS;DR",
        tosdrRating: "ToS;DR rating for {service}:",
        noTosdrInfo: "No TOSDR information available",
        tosdrGoodPoints: "Good points",
        tosdrBadPoints: "Bad points",
        tosdrNeutralPoints: "Neutral",
        tosdrHighlightedPoints: "Highlighted points:",
        tosdrCloseDetails: "Close details",
        tosdrLoadError: "Error loading TOSDR details",
        scoreNotAvailable: "Score not available",
        scoreExplanationNotAvailable: "Score explanation not available",
        noTosdrData: "No ToS;DR rating available",
        useAISummary: "Click 'Summarize Policy' to generate an AI summary",
    },
    history: {
  ...
  es: {
    ...
    summary: {
      ...
      sendingRequest: "Pidiéndole a la IA que lo lea...",
        ...
        usingTosdr: "Se encontró calificación de ToS;DR",
        tosdrSource: "Datos de ToS;DR",
        tosdrRating: "Calificación ToS;DR para {service}:",
        noTosdrInfo: "Sin información de TOSDR",
        tosdrGoodPoints: "Puntos buenos",
        tosdrBadPoints: "Puntos malos",
        tosdrNeutralPoints: "Neutrales",
        tosdrHighlightedPoints: "Puntos destacados:",
        tosdrCloseDetails: "Cerrar detalles",
        tosdrLoadError: "Error al cargar detalles de TOSDR",
  ...
  fr: {
    ...
    summary: {
      ...
      sendingRequest: "On demande à l’IA de s’en charger...",
        ...
        usingTosdr: "Note ToS;DR trouvée",
        tosdrSource: "Données de ToS;DR",
        tosdrRating: "Note ToS;DR pour {service}:",
        noTosdrInfo: "Aucune information ToS;DR disponible",
        tosdrGoodPoints: "Points positifs",
        tosdrBadPoints: "Points négatifs",
        tosdrNeutralPoints: "Neutres",
        tosdrHighlightedPoints: "Points mis en évidence:",
        tosdrCloseDetails: "Fermer les détails",
        tosdrLoadError: "Erreur lors du chargement des détails ToS;DR",
  ...
  pt: {
    ...
    summary: {
      ...
      sendingRequest: "Pedindo pra IA lidar com isso...",
        ...
        usingTosdr: "Classificação ToS;DR encontrada",
        tosdrSource: "Dados do ToS;DR",
        tosdrRating: "Classificação ToS;DR para {service}:",
        noTosdrInfo: "Nenhuma informação ToS;DR disponível",
        tosdrGoodPoints: "Pontos positivos",
        tosdrBadPoints: "Pontos negativos",
        tosdrNeutralPoints: "Neutros",
        tosdrHighlightedPoints: "Pontos destacados:",
        tosdrCloseDetails: "Fechar detalhes",
        tosdrLoadError: "Erro ao carregar detalhes do ToS;DR",
  ...
  de: {
    ...
    summary: {
      ...
      sendingRequest: "Bitte die KI, das zu lesen...",
        ...
        usingTosdr: "ToS;DR-Bewertung gefunden",
        tosdrSource: "Daten von ToS;DR",
        tosdrRating: "ToS;DR-Bewertung für {service}:",
        noTosdrInfo: "Keine ToS;DR-Informationen verfügbar",
        tosdrGoodPoints: "Positive Punkte",
        tosdrBadPoints: "Negative Punkte",
        tosdrNeutralPoints: "Neutral",
        tosdrHighlightedPoints: "Hervorgehobene Punkte:",
        tosdrCloseDetails: "Details schließen",
        tosdrLoadError: "Fehler beim Laden der ToS;DR-Details",
  ...
  it: {
    ...
    summary: {
      ...
      sendingRequest: "Chiedendo all’IA di leggerlo...",
        ...
        usingTosdr: "Valutazione ToS;DR trovata",
        tosdrSource: "Dati da ToS;DR",
        tosdrRating: "Valutazione ToS;DR per {service}:",
        noTosdrInfo: "Nessuna informazione ToS;DR disponibile",
        tosdrGoodPoints: "Punti positivi",
        tosdrBadPoints: "Punti negativi",
        tosdrNeutralPoints: "Neutri",
        tosdrHighlightedPoints: "Punti evidenziati:",
        tosdrCloseDetails: "Chiudi dettagli",
        tosdrLoadError: "Errore nel caricamento dei dettagli ToS;DR",
